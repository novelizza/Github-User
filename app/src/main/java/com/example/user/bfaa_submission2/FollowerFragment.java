...
public class FollowerFragment extends Fragment {
    ...
    private ProgressBar pbBar_Follower;

    private RecyclerView rcFollowers;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcFollowers = view.findViewById(R.id.rcList_Follower);
        pbBar_Follower = view.findViewById(R.id.pbBar_Follower);

        String url = account.getUsername() + "/followers";
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                pbBar_Follower.setVisibility(View.GONE);
                rcFollowers.setVisibility(View.VISIBLE);
                ...
                try {
                    ...
                    rcFollowers.setLayoutManager(new LinearLayoutManager(getActivity()));
                } catch (Exception e) {
