...
//        Cursor result = noteHelper.queryAll();
        ...
        ReycleViewAdapter adapter = new ReycleViewAdapter(FavoriteActivity.this, listUsername, listURL, listAvatar);
        rcListFav.setAdapter(adapter);
        rcListFav.setLayoutManager(new LinearLayoutManager(FavoriteActivity.this));
    }
}